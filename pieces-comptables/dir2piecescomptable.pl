#! /usr/bin/env perl
# NGW Don't make database insert in find loop !!
use strict;
use warnings;
use File::Basename;
use File::Find;
...
#			push @record_pc,$md5;
			...
			my $res_insert = $schema->resultset('Piececomptable')->populate([ [qw/piececomptable_id piececomptable_md5/], [ $io, $md5 ] ]);			

			my $res_insert2 = $schema->resultset('Piececomptable')->populate([ [qw/piececomptable_id piececomptable_md5/ ], @record_pc ]);			
		}	
	}
=begin comment
